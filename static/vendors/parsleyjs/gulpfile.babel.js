...
function buildDoc(done) {
  var dest = 'szfgw/annotated-source/';
...
function writeVersion() {
  return gulp.src(['index.html', 'szfgw/download.html', 'README.md'], { base: "./" })
...
function buildDocTest() {
  return _runBrowserifyBundle(browserifyBundler(), './szfgw/assets/spec-build.js');
}
...
gulp.task('build-szfgw', buildDoc);

// Build the annotated documentation
gulp.task('build-szfgw-test', buildDocTest);
